                        ...
                        <form role="form" action="" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?php echo error('address') ? 'is-invalid' : ''; ?>" id="address" name="address" value="<?php echo e( old('address') ); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control <?php echo error('phone') ? 'is-invalid' : ''; ?>" id="phone" name="phone"value="<?php echo e( old('phone') ); ?>">
